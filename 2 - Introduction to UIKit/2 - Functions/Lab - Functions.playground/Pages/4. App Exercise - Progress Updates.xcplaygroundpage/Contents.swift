 ...
 */
func progressUpdate (_steps:Int = 2400,_goal:Int = 10_000){
    if _steps < _goal/10 {
        print("You're off to a good start.")
    }else if _steps < _goal/50{
        print("You're almost halfway there!")
    }else if _steps < _goal*9/10{
        print("You're over halfway there!")
    }else if _steps < _goal{
...
func pacing (_currentDistance:Double = 500 , _totalDistance:Double = 2500, _currentTime:Double = 35.5, _goalTime:Double = 50){
